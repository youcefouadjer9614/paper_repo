...
class TOUCH_VER(Dataset):
    def __init__(self, train_phase=None):
        ...
        if self.train_phase:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Auth_Train_Touch.xlsx")
        else:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Auth_Test_Touch.xlsx")
