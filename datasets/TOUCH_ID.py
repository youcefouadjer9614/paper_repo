...
class TOUCH_ID(Dataset):
    def __init__(self, train_type, train_phase=None):
        ...
        self.train_type = train_type    # pretraining or finetuning
        self.train_phase = train_phase  # training or testing

        if self.train_phase:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Rec_Train_Touch.xlsx")
        else:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Rec_Test_Touch.xlsx")
