...
class HMOG_ID(Dataset):
    ...
    def __init__(self, train_type, train_phase=None):
        ...
        if self.train_phase:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Rec_Train_HMOG.xlsx")
        else:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Rec_Test_HMOG.xlsx")
