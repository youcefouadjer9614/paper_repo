...
class HMOG_VER(Dataset):
    def __init__(self, train_phase=False):
        ...
        if self.train_phase:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Auth_Train_HMOG.xlsx")
        else:
            data_frame = pd.read_excel("C:/Users/user/python_paper/dataset/Auth_Test_HMOG.xlsx")
