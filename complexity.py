...
def complexity_parser():
    ...
    parser.add_argument('--version', default="b0", type=str, help="version of EfficientNet Baseline: from b0 to b7")
...
if 'MobileNetV1' in args.net:
    ...
    model = models.EfficientNet(input_data[0], input_data[1], input_data[2], num_classes=2,version=args.version)
